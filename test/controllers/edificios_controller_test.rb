...
class EdificiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edificio" do
    assert_difference('Edificio.count') do
      post edificios_url, params: { edificio: { address: @edificio.address, city: @edificio.city, name: @edificio.name } }
    end
  ...
  test "should update edificio" do
    patch edificio_url(@edificio), params: { edificio: { address: @edificio.address, city: @edificio.city, name: @edificio.name } }
